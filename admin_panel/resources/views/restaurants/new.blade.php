...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Add a Restaurant') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="/restaurants">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="delivery_charge" type="number" class="form-control @error('delivery_charge') is-invalid @enderror" name="delivery_charge" value="{{ old('delivery_charge') }}">
